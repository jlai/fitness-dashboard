...
keys (new first) in the matching `ACCEPTED_KEYS` JWKS until existing tokens
expire or are re-encrypted:

```
SESSION_ACTIVE_KEY={...new session JWK...}
SESSION_ACCEPTED_KEYS={"keys":[{...new session JWK...},{...previous session JWK...}]}
```
